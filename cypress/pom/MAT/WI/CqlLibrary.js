...
export const shareCqllibrariesBtn = '#cqlLibrarySearchCellTable_gridToolbar > [title="Share"]'
export const deleteCqllibrariesBtn = '#cqlLibrarySearchCellTable_gridToolbar > [aria-label="Search History Delete library"]'
