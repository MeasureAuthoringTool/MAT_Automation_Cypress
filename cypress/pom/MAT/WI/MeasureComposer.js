...
export const includesNumber = '#includesBadge_Badge'
export const valueSets = '#valueSetLabel_Label'
export const valueSetsNumber = '#valueSetBadge_Badge'
export const codes = '#codesLabel_Label'
export const codesNumber = '#codesBadge_Badge'
...
export const scoreUnitSuggestions = '#completionOptions'
export const scoreUnitMoreItems = '#moreResults'
