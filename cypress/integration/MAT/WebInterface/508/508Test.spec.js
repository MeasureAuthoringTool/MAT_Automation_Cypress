...
describe('508', () => {
  ...
  it.skip('508 test check for all', () => {

    cy.checkA11y()

  })
  it.skip('specify values in options', () => {
    cy.checkA11y( null,{
      runOnly: {
        type: 'tag',
  ...
  it.skip('Only logs a11y violations while allowing the test to pass', () => {
    // Do not fail the test when there are accessibility failures
    cy.checkA11y(null, null, null, {skipFailures: true})

  })
  it.skip('508 test check for one element or section', () => {
