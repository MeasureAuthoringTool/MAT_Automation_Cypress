...
describe('Test cohort Grouping Validation Messages for FHIR Measure in Measure Packager', function () {
  ...
  it('Validate error Messages for FHIR Cohort Measure', () => {
    ...
    //helper.enterText(measurelibrary.searchInputBox, "")
    ...
    //Proceed to CQL Workspace and enter the cql
    cy.get(measureComposer.cqlWorkspace).click()
    cy.get(measureComposer.cqlWorkspaceTitleCQLLibraryEditor).click()
    cy.get()
