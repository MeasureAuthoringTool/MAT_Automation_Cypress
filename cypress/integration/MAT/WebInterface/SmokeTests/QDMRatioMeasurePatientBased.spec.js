...
//Smoke test for QDM Ratio Measure Patient Based. Create Draft measure and Package

describe('QDM Ratio Measure Patient Based', () => {
  beforeEach('Login', () => {
    login.matLogin()
  })
  afterEach('Log Out', () => {
  ...
  it('Ratio QDM Patient Based, create Draft measure and package', () => {
    ...
    let measureName = 'QDMRatioPatientBased' + Date.now()
    ...
    dataCreation.addDefinition('Encounters With Falls with Major Injury', 'true')

    dataCreation.addDefinition('Falls With Major Injury', 'true')
    ...
    dataCreation.addDefinition('Qualifying Encounters', 'true')

    //Function

    dataCreation.addFunction('Denominator Observation', '1')

    dataCreation.addFunction('Numerator Observation', '2')
