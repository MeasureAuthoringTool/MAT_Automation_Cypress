...
let username = ''
let password = ''
let multipleMatUsername = ''
let multipleMatPassword = ''
let name = ''
let email = ''
let alt_username = ''
let alt_name = ''
...
if (Cypress.env('environment') === 'dev') {
  ...
  multipleMatUsername = Cypress.env('DEV_MULTIUSERNAME')
  multipleMatPassword = Cypress.env('DEV_MULTIPASSWORD')
  ...
  multipleMatUsername = Cypress.env('TEST_MULTIUSERNAME')
  multipleMatPassword = Cypress.env('TEST_MULTIPASSWORD')
...
export const loginUserWithMultipleMAT = (multipleUser) => {

    if (multipleUser === undefined) {
      cy.clearCookies()
    ...
    // else if (multipleUser === 'alternative'){
    //   cy.clearCookies()
    ...
    //     win.sessionStorage.clear()
    //   })
    //   oktaMultipleLogin(alt_username, password, alt_name, alt_email)
    // }
...
export const oktaMultipleLogin = (un, pw, storage_name, storage_email) => {

  if (un === undefined) {
    un = multipleMatUsername
  }
  if (pw === undefined) {
    pw = multipleMatPassword
  }
  if (storage_name === undefined) {
    storage_name = name
  }
